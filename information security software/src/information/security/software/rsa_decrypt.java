 ...
 * @author 1602366
 */
public class rsa_decrypt extends javax.swing.JFrame {

    /**
     * Creates new form rsa_decrypt
     */
    public rsa_decrypt() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rsa_decrypt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
