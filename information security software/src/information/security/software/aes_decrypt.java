 ...
 * @author 1602366
 */
public class aes_decrypt extends javax.swing.JFrame {

    /**
     * Creates new form aes_decrypt
     */
    public aes_decrypt() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(aes_decrypt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new aes_decrypt().setVisible(true);
            }
        });
    }
